...
/* Quiet depth and soft gradients; stable click-only source inspection. */
...
header{{background:linear-gradient(110deg,#f9fcff 0%,#eef4fb 48%,#edf7f4 100%);border-bottom:1px solid #cfdce6;box-shadow:0 2px 12px #284b6310}}h1{{letter-spacing:.3px}}h1::before{{content:'';display:inline-block;width:9px;height:21px;margin-right:11px;vertical-align:middle;border-radius:4px;background:linear-gradient(160deg,#5b80b2,#79b7a4)}}#stats{{background:#ffffffb8;border-color:#d4e1e7;box-shadow:0 2px 5px #304b6010}}
#network{{background-image:radial-gradient(circle,#7590a41f .8px,transparent 1px),radial-gradient(ellipse at 8% 8%,#dce9f7b3,transparent 58%),radial-gradient(ellipse at 90% 80%,#deeee6a6,transparent 58%),linear-gradient(145deg,#f7f9fc,#f1f5f8);background-size:22px 22px,100% 100%,100% 100%,100% 100%}}
#tools{{padding:9px;border:1px solid #ffffffd9;border-radius:12px;background:#ffffffdb;box-shadow:0 4px 20px #3e5b7012,0 0 0 1px #d9e3ea88;backdrop-filter:blur(12px)}}.tool,.action,#search{{border-radius:7px;border-color:#d2dfe7}}.tool,.action{{background:linear-gradient(#ffffff,#f3f7fa)}}.tool:hover,.action:hover{{background:linear-gradient(#f5faff,#e8f1f8);border-color:#91afc5;color:#355b77}}#search{{background:#f8fbfd}}#hint{{background:#ffffffad;border:1px solid #ffffffdb;color:#687f90;border-radius:8px}}
#view{{background:linear-gradient(145deg,#f9fbfe,#f1f6f7);border-left:1px solid #cedce5;box-shadow:-5px 0 22px #35546b08}}#empty{{gap:10px;background:radial-gradient(ellipse at 70% 35%,#dce8f55c,transparent 65%)}}#empty::before{{content:'</>';display:grid;place-items:center;justify-self:center;width:58px;height:58px;margin-bottom:10px;border-radius:17px;border:1px solid #d4e2eb;background:linear-gradient(135deg,#fff,#e8f0f6);box-shadow:0 8px 22px #35546b0c;color:#7696ad;font:21px Consolas,monospace}}#empty span{{max-width:260px;line-height:1.9;font-size:13px;color:#798b98}}
#bar{{background:linear-gradient(120deg,#f1f6fb,#f5f9f7);border-bottom-color:#d9e4ea}}.chip{{background:linear-gradient(120deg,#e5eef6,#eaf2f3);border:1px solid #d6e2e9;border-radius:5px;color:#42637a}}.chip:hover{{background:#dcebf4}}pre{{background:linear-gradient(90deg,#f4f7fa 0,#f4f7fa 5px,#fdfefe 5px);padding-left:22px;scrollbar-width:thin;scrollbar-color:#c4d3de transparent}}
